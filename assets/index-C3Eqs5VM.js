(function(){const V=document.createElement("link").relList;if(V&&V.supports&&V.supports("modulepreload"))return;for(const I of document.querySelectorAll('link[rel="modulepreload"]'))ye(I);new MutationObserver(I=>{for(const $ of I)if($.type==="childList")for(const oe of $.addedNodes)oe.tagName==="LINK"&&oe.rel==="modulepreload"&&ye(oe)}).observe(document,{childList:!0,subtree:!0});function h(I){const $={};return I.integrity&&($.integrity=I.integrity),I.referrerPolicy&&($.referrerPolicy=I.referrerPolicy),I.crossOrigin==="use-credentials"?$.credentials="include":I.crossOrigin==="anonymous"?$.credentials="omit":$.credentials="same-origin",$}function ye(I){if(I.ep)return;I.ep=!0;const $=h(I);fetch(I.href,$)}})();var _o={exports:{}},vr={},Co={exports:{}},F={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var zs;function Tc(){if(zs)return vr;zs=1;var R=Po(),V=Symbol.for("react.element"),h=Symbol.for("react.fragment"),ye=Object.prototype.hasOwnProperty,I=R.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,$={key:!0,ref:!0,__self:!0,__source:!0};function oe(ee,B,te){var xe,ne={},Z=null,We=null;te!==void 0&&(Z=""+te),B.key!==void 0&&(Z=""+B.key),B.ref!==void 0&&(We=B.ref);for(xe in B)ye.call(B,xe)&&!$.hasOwnProperty(xe)&&(ne[xe]=B[xe]);if(ee&&ee.defaultProps)for(xe in B=ee.defaultProps,B)ne[xe]===void 0&&(ne[xe]=B[xe]);return{$$typeof:V,type:ee,key:Z,ref:We,props:ne,_owner:I.current}}return vr.Fragment=h,vr.jsx=oe,vr.jsxs=oe,vr}var As;function Rc(){return As||(As=1,_o.exports=Tc()),_o.exports}var ie=Rc(),Ln=Po(),Pl={},zo={exports:{}},Me={},Ao={exports:{}},No={};/**
 * @license React
            ...
            >
              ...
              >
                ...
                <tr height="245" id="Image Frame Container" width="556">
                  ...
                  >
                    <img
                      src="https://optim.tildacdn.com/tild3365-3963-4362-b935-393062393966/-/format/webp/IMG_0687.png"
                      style="width: 570px; height: 307px"
                    />
                    <table
                      id="Image Frame Container"
                      style="
                    ...
                    >
                      <tbody>
                        ...
                        >
                            ...
                            >
                                                    <a
                              href="https://dzen.ru/video/watch/66ed9444a73cff7e5c4781cf?share_to=link"
...
`;Ln.useEffect(()=>{if(oe.current&&I==="preview"){const te=oe.current.contentDocument;te.open(),te.write(ee),te.close()}},[ee,I]);const B=async()=>{try{await navigator.clipboard.writeText(ee),ye(!0),setTimeout(()=>ye(!1),2e3)}catch(te){console.error("Failed to copy text: ",te)}};return ie.jsxs("div",{className:"container",children:[ie.jsx("div",{className:"left-panel",children:ie.jsxs("div",{className:"card",children:[ie.jsx("h1",{children:"Генератор приветственной рассылки"}),ie.jsxs("div",{className:"input-group",children:[ie.jsx("label",{htmlFor:"name",children:"Имя нового члена команды"}),ie.jsx("input",{id:"name",type:"text",placeholder:"Введите имя",value:R,onChange:te=>V(te.target.value)})]}),ie.jsx("button",{onClick:B,children:h?"Скопировано!":"Скопировать в буфер обмена"})]})}),ie.jsx("div",{className:"right-panel",children:ie.jsxs("div",{className:"card",children:[ie.jsxs("div",{className:"tabs",children:[ie.jsx("button",{className:`tab ${I==="preview"?"active":""}`,onClick:()=>$("preview"),children:"Превью"}),ie.jsx("button",{className:`tab ${I==="code"?"active":""}`,onClick:()=>$("code"),children:"HTML Код"})]}),ie.jsx("div",{className:"tab-content",children:I==="preview"?ie.jsx("div",{className:"iframe-container",children:ie.jsx("iframe",{ref:oe,title:"Email Preview",className:"preview-iframe"})}):ie.jsx("div",{className:"code-container",children:ie.jsx("pre",{children:ee})})})]})}),ie.jsx("style",{children:`
        .container {
          display: flex;
          gap: 20px;
          max-width: 1400px;
      ...
      `})]})};function Uc(){return ie.jsx("div",{children:ie.jsx(Dc,{})})}jc.createRoot(document.getElementById("root")).render(ie.jsx(Ln.StrictMode,{children:ie.jsx(Uc,{})}));
